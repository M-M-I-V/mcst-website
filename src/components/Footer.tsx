        ...
        <div className="mb-6 md:mb-0">
          <Link to="/">
            <img 
              ...
              alt="MCST Logo" 
              className="h-16 w-auto hover:scale-110 transition duration-500" 
            />
          </Link>
          ...
          <div className="mt-4 flex space-x-4">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 hover:scale-110 transition duration-500" fill="currentColor" viewBox="0 0 24 24">
                <path
                  fillRule="evenodd"
